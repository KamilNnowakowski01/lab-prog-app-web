...
const StoryDetailsCard: React.FC<StoryDetailsCardProps> = ({ story }) => {
    ...
    <Card>
      <Card.Header>
        <Stack direction="horizontal" gap={3} className="">
          ...
          <div className="ms-auto d-flex flex-wrap gap-2">
            ...
            <Link to={`/stories/delete/${story.id}`} className="btn btn-danger">
              Delete
            </Link>
          </div>
        </Stack>
      ...
      <Card.Footer className="d-flex justify-content-center">
        <div className="d-flex flex-wrap gap-2">
          ...
          <Link to={`/stories/${story.id}/tasks/`} className="btn btn-primary">
            Open Tasks
          </Link>
        </div>
      </Card.Footer>
